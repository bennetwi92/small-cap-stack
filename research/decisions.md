...
**How to read this.** Every decision has a stable ID (`D-01`…) that is never reused or renumbered,
and a **`**Status:**` line directly under its heading** — so whether an entry still holds is
answerable without reading its body. The index below is **generated from those status lines** by
`make decisions`; `tests/test_decisions.py` fails on a stale table, so it cannot drift from the log.
Cite a decision as `decisions.md §D-nn` rather than by line number.

IDs run in **file order, not date order** — the file is roughly chronological with exceptions, and
reordering it would break the "see below" cross-references and every `git blame` line. Sort by the
index's Date column instead. Superseding entries live *below* the ones they supersede, so reading
down is reading forward in time within a topic.

<!-- BEGIN DECISION INDEX (generated by `make decisions` — do not edit by hand) -->

| ID | Date | Decision | Issues | Status |
|---|---|---|---|---|
| [D-01](#d-01--locked-decisions-the-research-phase-closeout-table-2026-06-29) | 2026-06-29 | Locked decisions: the research-phase closeout table | — | LIVE — rows 5 (VPS) and 10 (storage) carry their own inline revisions |
| [D-02](#d-02--core-architectural-principle-store-raw-compute-derived-on-read-q11-2026-06-29-62) | 2026-06-29 | Core architectural principle: store raw, compute derived on read (Q11) | #62 | LIVE |
| [D-03](#d-03--standing-principle-collect-before-you-filter-2026-08-07-569) | 2026-08-07 | Standing principle: collect before you filter | #569 | LIVE — a Phase-1 collection stance, not a trading philosophy; revisit at the Phase-2 gate |
| [D-04](#d-04--entry--stop-spec-for-max-r-measurement-2026-07-01-93) | 2026-07-01 | Entry / stop spec for Max-R measurement | #93 | LIVE — the 5-tick entry trigger is superseded by D-17; the stop and the analysis window stand |
| [D-05](#d-05--strategy-notes-from-notesmd-exhaustion--re-entry-pre-market-orders-2026-06-29-3637) | 2026-06-29 | Strategy notes from `notes.md`: exhaustion / re-entry, pre-market orders | #36/#37 | LIVE |
| [D-06](#d-06--scope-the-top-few-scanner-rows-widened-to-the-full-cap-for-collection-2026-06-29) | 2026-06-29 | Scope: the top few scanner rows, widened to the full cap for collection | — | LIVE — scan breadth raised 10 → 50 on 2026-07-12 |
| [D-07](#d-07--validation-spikes-before-building-scanner-bars-news-tradability-2026-06-29-891025) | 2026-06-29 | Validation spikes before building: scanner, bars, news, tradability | #8/#9/#10/#25 | LIVE — spike D's placeholder `tradable_gate` was deleted as dead scaffolding (#517); the requirement stands, unimplemented |
| [D-08](#d-08--architecture-ib_async-asyncio-systemd-duckdb-over-parquet-2026-06-29-71112) | 2026-06-29 | Architecture: ib_async, asyncio, systemd, DuckDB over Parquet | #7/#11/#12 | LIVE |
| [D-09](#d-09--setup_count-retired-2026-07-02-112) | 2026-07-02 | `setup_count` retired | #112 | LIVE |
...
| [D-17](#d-17--engine-v2-entry-1-tick-trigger-3-tick-conservative-fill-2026-07-10-182190) | 2026-07-10 | Engine v2 entry: 1-tick trigger, 3-tick conservative fill | #182/#190 | LIVE — supersedes D-04's 5-tick entry trigger |
| [D-18](#d-18--fundamentals-source-yfinance-ibkr-unentitled-2026-06-29-17) | 2026-06-29 | Fundamentals source: yfinance, IBKR unentitled | #17 | LIVE |
| [D-19](#d-19--repo-visibility-public-by-choice-2026-06-29) | 2026-06-29 | Repo visibility: public by choice | — | LIVE — reaffirmed on cost grounds by D-26 |
| [D-20](#d-20--phone-driven-control-plane-github-is-the-control-plane-2026-06-30-5155) | 2026-06-30 | Phone-driven control plane: GitHub is the control plane | #51–#55 | LIVE |
| [D-21](#d-21--virtual-portfolio-tracker--execution-model-2026-07-15-230) | 2026-07-15 | Virtual-portfolio tracker + execution model | #230 | LIVE — amended #234/#237/#463/#476; its selection rules moved to the engine in D-35 and were changed by D-36 and D-37 |
| [D-22](#d-22--getting-paid-withdrawals-uk-tax-running-cost-2026-07-16) | 2026-07-16 | Getting paid: withdrawals, UK tax, running cost | — | LIVE |
| [D-23](#d-23--adaptive-risk-throttle--kill-switch-2026-07-16-239) | 2026-07-16 | Adaptive risk throttle / kill-switch | #239 | REVERSED — ships OFF (`portfolio_risk_rungs=1`) since 2026-08-06 (#474); the implementation is kept and tested. Reverses D-21's no-kill-switch note. |
| [D-24](#d-24--ledger-gap-months--the-skipped-logs-two-populations-2026-07-16-249251) | 2026-07-16 | Ledger gap-months + the skipped log's two populations | #249/#251 | LIVE — refines D-21, D-23 and #232 |
| [D-25](#d-25--trading-calendar-of-record-exchange_calendars-xnys-2026-07-17-137) | 2026-07-17 | Trading calendar of record: exchange_calendars XNYS | #137 | LIVE — one `previous_session` since #514, which also kept `early_close_et` deliberately unwired |
| [D-26](#d-26--repo-stays-public-automation-stays-0-2026-07-17-344) | 2026-07-17 | Repo stays public; automation stays $0 | #344 | LIVE — the automation layer it was hosting was rolled back in D-27; the hosting decision stands |
| [D-27](#d-27--the-github-automation-layer-is-rolled-back-2026-07-19-377) | 2026-07-19 | The GitHub automation layer is rolled back | #377 | LIVE — amended by D-32, which brings the delegation loop back on its own |
| [D-28](#d-28--reports-are-repo-prose-served-by-pages-not-box-data-2026-07-31-392) | 2026-07-31 | Reports are repo prose served by Pages, not box data | #392 | LIVE |
| [D-29](#d-29--the-portfolio-page-projects-forward-and-says-when-it-can-pay-a-salary-2026-08-01-411) | 2026-08-01 | The portfolio page projects forward, and says when it can pay a salary | #411 | LIVE |
| [D-30](#d-30--the-2-year-harvest-runs-on-the-free-tier-delivered-nightly-2026-08-04-430) | 2026-08-04 | The 2-year harvest runs on the free tier, delivered nightly | #430 | LIVE — amended #460, which corrected the mechanism from scanner capacity to appearance timing |
| [D-31](#d-31--the-harvest-runs-as-a-memory-capped-nightly-job-not-a-batch-2026-08-04-431) | 2026-08-04 | The harvest runs as a memory-capped nightly job, not a batch | #431 | LIVE — amended #452/#455/#460 |
| [D-32](#d-32--delegation-comes-back-alone-2026-08-06-489) | 2026-08-06 | Delegation comes back, alone | #489 | LIVE — amends D-27 |
| [D-33](#d-33--reconstructed-sessions-publish-to-their-own-chart-namespace-2026-08-06-488) | 2026-08-06 | Reconstructed sessions publish to their own chart namespace | #488 | LIVE |
| [D-34](#d-34--open-drive-a-second-strategy-for-the-0930-open-2026-08-02-418) | 2026-08-02 | Open Drive: a second strategy for the 09:30 open | #418 | LIVE — specified, not traded. Its selection half and finding 1 are superseded by #535 (banded sequential commit). |
...
## D-01 — Locked decisions: the research-phase closeout table (2026-06-29)

**Status:** LIVE — rows 5 (VPS) and 10 (storage) carry their own inline revisions
...
## D-03 — Standing principle: collect before you filter (2026-08-07, #569)

**Status:** LIVE — a Phase-1 collection stance, not a trading philosophy; revisit at the Phase-2 gate
...
## D-04 — Entry / stop spec for Max-R measurement (2026-07-01, #93)

**Status:** LIVE — the 5-tick entry trigger is superseded by D-17; the stop and the analysis window stand
...
## D-05 — Strategy notes from `notes.md`: exhaustion / re-entry, pre-market orders (2026-06-29, #36/#37)
...
## D-06 — Scope: the top few scanner rows, widened to the full cap for collection (2026-06-29)

**Status:** LIVE — scan breadth raised 10 → 50 on 2026-07-12
...
## D-07 — Validation spikes before building: scanner, bars, news, tradability (2026-06-29, #8/#9/#10/#25)

**Status:** LIVE — spike D's placeholder `tradable_gate` was deleted as dead scaffolding (#517); the requirement stands, unimplemented
...
## D-08 — Architecture: ib_async, asyncio, systemd, DuckDB over Parquet (2026-06-29, #7/#11/#12)
...
## D-09 — `setup_count` retired (2026-07-02, #112)
...
## D-10 — Scanner price range widened to $1–$50 (2026-07-02, #126)
...
## D-11 — Entry appearance-gate is bar-close granular (2026-07-03, #122)

**Status:** SUPERSEDED — engine v2 reverted to bar-start on 2026-07-10 and the stricter shipped rule is kept, recorded 2026-08-07 (#605). Revises #99.
...
## D-12 — Entry staleness bound (2026-07-03, #130)
...
## D-14 — Bull-flag redefined: pole, flag, retracement, volume (2026-07-03, #127)

**Status:** LIVE — the colour-agnostic pole is superseded by D-16 and the 5-tick entry by D-17
...
## D-15 — Engine v2 volume gate = peak-bar (2026-07-10, #176)

**Status:** LIVE — reaffirms D-14
...
## D-16 — Engine v2 pole is colour-gated (2026-07-10, #182/#190)

**Status:** LIVE — supersedes D-14's colour-agnostic pole; v2 is the only engine since #296
...
## D-17 — Engine v2 entry: 1-tick trigger, 3-tick conservative fill (2026-07-10, #182/#190)

**Status:** LIVE — supersedes D-04's 5-tick entry trigger
...
## D-18 — Fundamentals source: yfinance, IBKR unentitled (2026-06-29, #17)
...
## D-19 — Repo visibility: public by choice (2026-06-29)

**Status:** LIVE — reaffirmed on cost grounds by D-26
...
## D-20 — Phone-driven control plane: GitHub is the control plane (2026-06-30, #51–#55)
...
## D-21 — Virtual-portfolio tracker + execution model (2026-07-15, #230)

**Status:** LIVE — amended #234/#237/#463/#476; its selection rules moved to the engine in D-35 and were changed by D-36 and D-37
...
## D-23 — Adaptive risk throttle / kill-switch (2026-07-16, #239)

**Status:** REVERSED — ships OFF (`portfolio_risk_rungs=1`) since 2026-08-06 (#474); the implementation is kept and tested. Reverses D-21's no-kill-switch note.
...
## D-24 — Ledger gap-months + the skipped log's two populations (2026-07-16, #249/#251)

**Status:** LIVE — refines D-21, D-23 and #232
...
## D-25 — Trading calendar of record: exchange_calendars XNYS (2026-07-17, #137)

**Status:** LIVE — one `previous_session` since #514, which also kept `early_close_et` deliberately unwired
...
## D-26 — Repo stays public; automation stays $0 (2026-07-17, #344)
...
## D-27 — The GitHub automation layer is rolled back (2026-07-19, #377)

**Status:** LIVE — amended by D-32, which brings the delegation loop back on its own
...
## D-28 — Reports are repo prose served by Pages, not box data (2026-07-31, #392)
...
## D-29 — The portfolio page projects forward, and says when it can pay a salary (2026-08-01, #411)
...
## D-30 — The 2-year harvest runs on the free tier, delivered nightly (2026-08-04, #430)

**Status:** LIVE — amended #460, which corrected the mechanism from scanner capacity to appearance timing
...
## D-31 — The harvest runs as a memory-capped nightly job, not a batch (2026-08-04, #431)

**Status:** LIVE — amended #452/#455/#460
...
## D-32 — Delegation comes back, alone (2026-08-06, #489)

**Status:** LIVE — amends D-27
...
## D-33 — Reconstructed sessions publish to their own chart namespace (2026-08-06, #488)
...
## D-34 — Open Drive: a second strategy for the 09:30 open (2026-08-02, #418)
...
## D-35 — The engine selects, the book executes (2026-08-07, #567)
...
## D-36 — The selection window opens to 04:00 (2026-08-07, #569)

**Status:** LIVE — reverses #405
...
## D-37 — The selection price band widens to $1–$50 for collection (2026-08-07, #608)

**Status:** LIVE — temporary and intended to be reversed once the record can say where the band belongs; supersedes #386
