...
The 2026-07-05 proposal for the chart-review page, **shipped as #140/#141** and overtaken since. Kept as the record of what was intended; it still describes the page as read-only, single-day and clipped, none of which is true of `docs/review.html`. It sat with **zero inbound references** for a month, which is why it went stale unnoticed — `tests/test_research_docs.py` now fails on an unreferenced doc.
