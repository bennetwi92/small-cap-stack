...
// not here; this page owns the live-day rail and the last completed session.
// Charting is the Review page's job — the dashboard's duplicate was removed.
...
function renderStats(st) {
  // stats.json is written only at EOD, so this is the last finished US
  // session — it stays put all day until the next close.
