...
class _VpsLedger:
    """The VPS running cost (~£5.70/mo — Hetzner's €6.59, an estimate not yet invoiced; see
    :mod:`small_cap_stack.config` and #284), charged at month rollover like the market-data fee.
